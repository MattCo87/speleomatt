...
final class Version20220318143745 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action_statregy DROP FOREIGN KEY FK_CBB80290B15F4BF6');
        ...
        $this->addSql('ALTER TABLE action_statregy DROP FOREIGN KEY FK_CBB80290529B93AD');
