 ...
 */
final class Version20220318143745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action_strategy (id INT AUTO_INCREMENT NOT NULL, actions_id INT DEFAULT NULL, strategies_id INT DEFAULT NULL, position_action VARCHAR(255) DEFAULT NULL, INDEX IDX_CBB80290B15F4BF6 (actions_id), INDEX IDX_CBB80290529B93AD (strategies_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE action_strategy ADD CONSTRAINT FK_CBB80290B15F4BF6 FOREIGN KEY (actions_id) REFERENCES action (id)');
        $this->addSql('ALTER TABLE action_strategy ADD CONSTRAINT FK_CBB80290529B93AD FOREIGN KEY (strategies_id) REFERENCES strategy (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action_strategy DROP FOREIGN KEY FK_CBB80290B15F4BF6');
        ...
        $this->addSql('ALTER TABLE action_strategy DROP FOREIGN KEY FK_CBB80290529B93AD');
